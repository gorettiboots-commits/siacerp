"""Pruebas unitarias e integración del prototipo NotificacionesFlotantes.
...
import src.views.sandbox_notificaciones as mod
from src.utils.icons import _GLIFOS
from src.views.sandbox_notificaciones import (
